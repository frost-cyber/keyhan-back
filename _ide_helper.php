...
')
     ...
     */ 
         ...
         *
         * @param $finalizeCallback|null
         * @return \Shetabit\Multipay\ReceiptInterface 
     ...
     */ 
        ...
        {
                        /** @var \Tzsk\Sms\Sms $instance */
                        return $instance->to($recipients);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function send($message, $callback = null)
        {
                        /** @var \Tzsk\Sms\Sms $instance */
                        return $instance->send($message, $callback);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class Sms extends \Tzsk\Sms\Facades\Sms {}
